...
It is in this layer where the magic happens and the AI gets access to the tools that it needs to provide real value. Since the [merging of the Semantic Kernel and AutoGen](https://github.com/microsoft/semantic-kernel/discussions/12779) teams there have been rumours of a new Agent orchestration framework from Microsoft that will supersede Semantic Kernel. When this framework arrives, it will probably be a natural choice in this layer.
